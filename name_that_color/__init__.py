# These module resources were translated to Python by Gino Perrotta - github.com/ginop/name-that-color

# from the JavaScript "Name that Color" by Chirag Mehta - http://chir.ag/tech/download/ntc
